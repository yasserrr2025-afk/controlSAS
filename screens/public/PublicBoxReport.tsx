          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white font-black text-sm leading-tight">{systemConfig?.school_name || 'اسم المدرسة'}</p>
              </div>
            </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8 pb-24">
        ...
        <div className="text-center pt-6 border-t border-slate-200 space-y-3">
          ...
          <p className="text-slate-400 text-sm font-bold">
            ...
            <span className="text-slate-300">{systemConfig?.school_name || 'اسم المدرسة'} — وزارة التعليم</span>
          </p>
        </div>
      </div>
    </div>
